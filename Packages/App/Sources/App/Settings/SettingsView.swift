    ...
    var body: some View {
        ...
        Form {
            ...
            Section {
                ...
                Text("MunkiStudio targets the Swift munkipkg fork — YAML build-info, --skip-import and --env support. Download & Install fetches the latest release from GitHub and installs it to /usr/local/munki (asks for your password). Leave the path blank to use that standard location.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
